...
2. Klik avatar → **Add an Organization**
...
| --------------------------------- | ----------------- | ------------------- |
| Bug fix, patch                    | `0.1.0` → `0.1.1` | `npm version patch` |
| New feature (backward-compatible) | `0.1.0` → `0.2.0` | `npm version minor` |
| Breaking change                   | `0.x.x` → `1.0.0` | `npm version major` |
...
>
> - [Changesets](https://github.com/changesets/changesets) — paling populer untuk monorepo
> - [Lerna](https://lerna.js.org/) — mature, banyak fitur
...
1. Buka [npmjs.com](https://www.npmjs.com/) → Avatar → **Access Tokens**
2. **Generate New Token** → pilih **Automation** (untuk CI/CD)
3. Copy token
